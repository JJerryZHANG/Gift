...
<link rel="stylesheet" href="<%=path%>/css/ddsmoothmenu.css"
	type="text/css" />
<link rel="stylesheet" href="<%=path%>/css/user.css" type="text/css" />
			...
			<div id="templatemo_main">
				...
				<div id="content" class="right">
					...
					<div id="info">
						<div id="user_info">
							<div id="photo">
								<img src="<%=path%>/images/<%=session.getAttribute("userpic")%>">
							</div>
							<div id="basic">
								<ul>
									<li>姓名：<%=session.getAttribute("search_name")%></li>
									<li>性别：<%=session.getAttribute("search_sex")%></li>
									<li>年龄：<%=session.getAttribute("search_age")%></li>
									<li>个性：<%=session.getAttribute("search_tag")%></li>
								</ul>
							</div>
						</div>
						<div id="like_title">喜欢的礼品：</div>
						<div id="gift_info">
							<div id="like">
								<a
									href="servlet/GiftdetailServlet?gName=<%=session.getAttribute("likename1")%>"><img
									src="images/product/<%=session.getAttribute("like1")%>"></a>
							</div>
							<div id="like">
								<a
									href="servlet/GiftdetailServlet?gName=<%=session.getAttribute("likename2")%>"><img
									src="images/product/<%=session.getAttribute("like2")%>"></a>
							</div>
							<div id="like">
								<a
									href="servlet/GiftdetailServlet?gName=<%=session.getAttribute("likename3")%>"><img
									src="images/product/<%=session.getAttribute("like3")%>"></a>
							</div>
						</div>
					</div>
