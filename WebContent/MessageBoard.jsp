			...
			<div id="templatemo_main">
				...
				<div id="content" class="right">
					...
					<div>
						...
						<%-- 获取数据库中的数据写入 --%>
						<textarea
							style="width: 700px; height: 450px; font-size: 20px; color: black; font-weight: bold;"
							readonly="readonly">
						<%=session.getAttribute("allMessage")%>					
						</textarea>
						<form action="servlet/MessServlet">
							<div height="20px">&nbsp;</div>
							<!-- 留言内容提交 -->
							<input type="text" style="width: 600px; height: 50px;"
								name="content">&nbsp;&nbsp;&nbsp; <input type="submit"
								value="提交留言">
							<div height="20px">&nbsp;</div>
						</form>
